    ...
    <div class="article-admin">
        <b-form>
            ...
            <b-form-group v-if="mode === 'save'" label="Conteúdo" label-for="article-content">
                <Editor v-model="article.content" api-key="umv3661e4y4yqwu0zhqke4bf9orjsge6ns4985jjwzccxfi8"
                    style="width: 100%; height: 400px;" id="article-content"
...
export default {
    ...
    methods: {
        ...
        save() {
            console.log('Conteúdo do editor:', this.article); // Aqui deve acessar o conteúdo do editor
            //this.article.content = this.editor; // Atribua o conteúdo ao artigo
